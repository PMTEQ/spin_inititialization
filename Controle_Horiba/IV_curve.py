...
d = u3.U3() #Ouverture du LABJACK pour le spectro
#Le DAC0 envoie l'impulsion pour commencer l'acquisition d'une donnée
#AIN0 sert a checker le moment actuel de l'acquisiton

#%% /!\ A remplir: 
    
info_datas='courbeI-V'#Informations sur les donnees
V_deb=-1 # Tension de d2but de mesure
V_fin=1 #Tension de fin de mesure
N_ech=5 # Nomnre de mesures a prendre
