...
input("Welcome to the program allowing you to take an IV curve. Please, press enter here.")
...
try : 
    ...
    print("Couldn't open the Keithley chexk the COM port and go to the python file to check the working of the program")
