...
vect_delay = [1,10,20,30,40,50] # in us, #The different delays we want to measure between the end of the pump and the probe
...
mydg.set_modu_EOM_channel(2) # Indicating the channel the EOM is connecting on
